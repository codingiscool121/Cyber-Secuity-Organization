...
var hints = [
    ...
    "Program that looks legitimate, like a Google or Microsoft icon, but can take control of your computer.",
    ...
    "Use of online advertising to spread malware. This generally tricks the user into clicking on a legitmate looking ad. Can also come in the form of free virus protection softwares."
...
//This feature does not work for Safari or old verisons of IE because "key" is not available in those browsers
...
function checkWin() {
    if(wordStatus === answer) {
        document.getElementById('keyboard').innerHTML = "You got this one correct. But how about the next word?";
        correct = correct + 1;
        lvldstatus = true;
        completeFx.play();
    }
